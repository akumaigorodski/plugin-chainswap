...
libraryDependencies += "fr.acinq.eclair" % "eclair-core_2.13" % "0.4.3-SNAPSHOT" from "file:///home/anton/Desktop/ChainSwap/src/main/jar/eclair-core_2.13-0.4.3-SNAPSHOT.jar"
libraryDependencies += "fr.acinq.eclair" % "eclair-node_2.13" % "0.4.3-SNAPSHOT" from "file:///home/anton/Desktop/ChainSwap/src/main/jar/eclair-node_2.13-0.4.3-SNAPSHOT.jar"
...
libraryDependencies += "org.zeromq" % "jeromq" % "0.5.0" // Same as Eclair
